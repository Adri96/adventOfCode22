...
def checkMatch(oponent_election, your_election):
	#print(your_election, oponent_election)
	oponent_election = convertToElection(oponent_election)
	your_election = convertToElection(your_election)
	# math trick...
	#print(your_election, oponent_election)
	return your_election.value + 3*(checkIfWin(oponent_election, your_election).value)
